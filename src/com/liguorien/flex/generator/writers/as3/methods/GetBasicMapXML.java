 ...
 * @author Nicolas Désy
 */
public class GetBasicMapXML extends ContextMethodWriter {
    
    public GetBasicMapXML(){
        super(GetBasicMapXML.class.getName());
    }
    ...
    public void writeMethod(Writer w, FlexGenerator g,
        ...
        w.write("nod.appendChild(<e KEY={key}>{map[key]}</e>);\n");
        g.writeIndentation(w, 3);
        w.write("}\n");
        g.writeIndentation(w, 3);
        w.write("return nod;\n");
