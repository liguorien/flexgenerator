...
/**
 * <p>Generates a method who builds a dom4j element from an array of basic
 * types. (boolean, int, String, etc...)</p>
 ...
 * @author Nicolas Désy
 */
public class GetArrayElement extends ContextMethodWriter {
        
    /**
     * Creates a new instance of GetArrayElement
     */
    public GetArrayElement(){
        super(GetArrayElement.class.getName());
    }
