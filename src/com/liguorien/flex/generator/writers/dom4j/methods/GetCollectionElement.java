 ...
 * @author Nicolas Désy
 */
public class GetCollectionElement extends ContextMethodWriter {
        
    public GetCollectionElement(){
        super(GetCollectionElement.class.getName());
    }
    ...
    public void writeMethod(Writer w, FlexGenerator g,
        ...
        w.write("if(coll == null) return null;\n");
        g.writeIndentation(w, 2);
        ...
        w.write("int i = 0;\n");
        g.writeIndentation(w, 2);
        w.write("for(Object obj : coll)");
        g.writeCurlyBrace(w, 2);
        g.writeIndentation(w, 3);
        w.write("el.addElement(\"e\").setText(obj.toString());\n");
        g.writeIndentation(w, 2);
        w.write("}\n");
        g.writeIndentation(w, 2);
        w.write("return el;\n");
